...
namespace Szakdoli.Migrations
{
    ...
    [Migration("20200224175143_LokacioJav")]
    partial class LokacioJav
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Szakdoli.Models.Raklap", b =>
                {
                    b.Property<int>("RaklapSzam")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Szakdoli.Models.Alkalmazott", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Alkalmazott");
                });
            ...
            modelBuilder.Entity("Szakdoli.Models.Lokacio", b =>
                {
                    b.HasOne("Szakdoli.Models.Raklap", "Raklap")
                        .WithOne("Lokacio")
                        .HasForeignKey("Szakdoli.Models.Lokacio", "RaklapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Szakdoli.Models.Termek", b =>
                {
                    b.HasOne("Szakdoli.Models.Raklap", "Raklap")
                        .WithOne("Termek")
                        .HasForeignKey("Szakdoli.Models.Termek", "RaklapID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
